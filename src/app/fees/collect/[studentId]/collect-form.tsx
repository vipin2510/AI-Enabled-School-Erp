...
type Props = {
  ...
  // Signed-in user's name — prefilled into "Collected by" so the receipt is
  // stamped with who generated it (the cashier can still override).
      ...
      <aside className="space-y-4">
        <div className="card p-5 space-y-3 sticky top-6">
          ...
          <div className="pt-2 space-y-3">
            ...
            />
            <div>
              <div className="text-xs text-stone-500 mb-1">Generated by</div>
